...
def createDonkeys(dindexarr,dlenarr,counter,numofdonkeys,newboard,mainarr,COLUMNS):	#Creates 1,2,3 donkeys depending on level
...
def createBalls(ball1time, ball2time, currball, numofball, dobjectarr, COLUMNS, fbarr):		#Creates variable number of fireballs depending on level
		ball2time = time.time()
